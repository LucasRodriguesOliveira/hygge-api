...
describe('ProductController', () => {
  ...
  describe('List', () => {
    ...
    describe('order by name asc', () => {
      ...
      it('should return a list of products', async () => {
        const result = await productController.list(queryProductDto);
  ...
  describe('Find', () => {
    describe('success', () => {
      ...
      it('should return a product by id', async () => {
        const result = await productController.find(product.id);
  ...
  describe('delete', () => {
    ...
    const productDeleteResponse: DeleteProductResponse = {
      isDeleted: true,
    };
    ...
    it("should add a date value to the 'deletedAt' field and return a boolean value if it was successfull", async () => {
      const result = await productController.delete(product.id);

      expect(result).toStrictEqual(productDeleteResponse);
    });
  });
});
